...
const Header = () => {
    ...
    // console.log("selected_product_in_header", products, total, isLoading)
        ...
        <div className='header_container'>
            <div className='head_flex'>
                <div className='header_headings'>
                    <Link to="/products">
                        <span className='spans'>e-com</span>
                    </Link>
                    <div className='header_cart'>
                        <div className='header_count'>{total}</div>
                        <Link to="/order">
                            <p className='header_Cart' >Cart</p>
                        </Link>
                    </div>
                </div>
                <div className='header_headingss'>
                    <Link to="/">
                        <span>Logout</span>
                    </Link>
                </div>
